...
export const _subconPerformance = [{
  id: 1,
  Subcontractor: 'Subcon A',
  Actual: 2,
  Plan: 1.8,
  Manpower: 500,
  status: 'progress'
  ...
  id: 3,
  Subcontractor: 'Subcon C',
  Actual: 9.3,
  Plan: 10,
  Manpower: 1200
},{
  id: 4,
  Subcontractor: 'Subcon D',
  Actual: 0.0,
  Plan: 1,
  Manpower: 200
}]

export const _disciplineProgress = [{
  id: 1,
  Subcontractor: 'Civil',
  Actual: 1.59,
  Plan: 1.8,
  ...
  id: 2,
  Subcontractor: 'Piling',
  Actual: 0.59,
  Plan: 0.9,
  status: 'progress'
},{
  id: 3,
  Subcontractor: 'Underground',
  Actual: 0.59,
  Plan: 0.9,
  status: 'progress'
}]
